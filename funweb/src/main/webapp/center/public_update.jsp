...
publicDTO news = dao.selectBoard(num);
		...
		<article>
			...
			<input type="hidden" name="page" value="" >
				<table id="notice">
					<tr>
						<td>글쓴이</td>
						<td><input type="text" name="name"  value="<%=news.getName()%>"required="required"></td>
					</tr>
						<td>비밀번호</td>
						<td><input type="password" name="pass" value="<%=news.getPass()%>" required="required"></td>
					<tr>
						<td>제목</td>
						<td><input type="text" name="subject" value="<%=news.getSubject()%>" required="required"></td>
					</tr>
					<tr>
						<td>내용</td>
