...
if(endPage >maxPage){
 ...
 ArrayList<serviceDTO> boardList = dao.selectBoardList(PageNum,listLimit);
	...
	<div id="wrap">
		...
		<h1>Service_center</h1>
			...
			<%
				...
				//2번방법 향상된 for
				for(serviceDTO board1 : boardList){
				...
				<tr onclick="location.href='service_content.jsp?num=<%=board1.getNum()%>&page=<%=PageNum%>'">
					<td ><%=board1.getNum() %></td>
			...
			<div id="table_search">
				<input type="button" value="상담문의"  class="btn" onclick="location.href='service_write.jsp'">
			</div>
			<div id="table_search">
			...
			<div id="page_control">	
				...
				<a href="service.jsp?page=<%=PageNum -1 %>" >Prev</a>
				...
				<%if(PageNum<maxPage){ %>
				<a href="service.jsp?page=<%=PageNum +1%>">Next</a>
			...
			<figure class="ceo">
				...
				<figcaption><h4>고객센터 운영시간:09:00~17:30 | TEL)010-8572-7789</h4></figcaption>
			</figure>
			<p></p>
		</article>
		<div class="clear"></div>
